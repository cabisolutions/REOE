...
<body>
    <div class="container pt-4 pb-4">
        ...
        ?>
        <form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="POST" class="needs-validation" novalidate
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nombre" required class="form-control form-control-sm" id="nombre"
                            value="<?php echo htmlentities($_POST['nombre'] ?? '') ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="primer_apellido" required class="form-control form-control-sm"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="segundo_apellido" required class="form-control form-control-sm"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="sexo" id="sexo1" required
                                value="Femenino" <?php echo 'Femenino' == ($_POST['sexo'] ?? '') ? 'checked' : '' ?>>
                            <label class="form-check-label" for="sexo1">
                                Femenino
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="sexo" id="sexo2" required
                                value="Masculino" <?php echo 'Masculino' == ($_POST['sexo'] ?? '') ? 'checked' : '' ?>>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="fecha_nacimiento" required class="form-control form-control-sm"
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="tel" name="numero_celular" required class="form-control form-control-sm"
                                    id="numero_celular"
                                    value="<?php echo htmlentities($_POST['numero_celular'] ?? '') ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="email" name="correo_electronico" required
                                    class="form-control form-control-sm" id="correo_electronico"
                                    value="<?php echo htmlentities($_POST['correo_electronico'] ?? '') ?>">
                                <div class="invalid-feedback">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="password" name="contrasena" <?php echo $requerido; ?> 
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="perfil" id="perfil1" required
                                        value="Administrador"
                                        <?php echo 'Administrador' == ($_POST['perfil'] ?? '') ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="perfil1">
                                        Administrador
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="perfil" id="perfil2" required
                                        value="Cliente"
                                        <?php echo 'Cliente' == ($_POST['perfil'] ?? '') ? 'checked' : '' ?>>
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="estatus" id="estatus1" required
                                        value="Activo"
                                        <?php echo 'Activo' == ($_POST['estatus'] ?? '') ? 'checked' : '' ?>>
                                    <label class="form-check-label" for="estatus1">
                                        Activo
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="estatus" id="estatus2" required
                                        value="Inactivo"
                                        <?php echo 'Inactivo' == ($_POST['estatus'] ?? '') ? 'checked' : '' ?>>
                            ...
                            <div class="mb-3">
                                ...
                                <img id="imagen_identificacion" src="
                                            ...
                                            if (isset($_POST['identificacion']))
                                                echo 'usuarios/identificaciones/' . $_POST['identificacion']
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="file" name="comprobante_domicilio" <?php
                                                                                    echo $requerido;
                                                                                    ?>
                                    class="form-control form-control-sm" id="comprobante_domicilio" accept=".jpg"
                                    onchange="mostrarImagen(event,'comprobante_domicilio')">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="calle" required class="form-control form-control-sm" id="calle"
                                    value="<?php echo htmlentities($_POST['calle'] ?? '') ?>">
                                <div class="invalid-feedback">
                                    Escribe tu calle
                                </div>
                            </div>
                        ...
                        <div class="col-sm-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="numero_exterior" required class="form-control form-control-sm"
                                    id="numero_exterior"
                                    value="<?php echo htmlentities($_POST['numero_exterior'] ?? '') ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="col-sm-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="numero_interior" class="form-control form-control-sm"
                                    id="numero_interior" aria-describedby="numero_interiorHelp"
                                    value="<?php echo htmlentities($_POST['numero_interior'] ?? '') ?>">
                        ...
                        <div class="col-sm-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="codigo_postal" required class="form-control form-control-sm"
                                    id="codigo_postal"
                                    value="<?php echo htmlentities($_POST['codigo_postal'] ?? '') ?>">
                                <div class="invalid-feedback">
