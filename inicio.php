        ...
        <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="7000">
                ...
                <div class="carousel-caption">
                    <h1 class="display-3 text-white mb-5">Encuentra los mejores espacios</h1>
                </div>
            </div>
            <div class="carousel-item" data-bs-interval="7000">
                <img src="img/oficina1.jpg" class="d-block w-100 indexCarousel" alt="Espacio para eventos con pista de baile">
                <div class="carousel-caption">
                    <h1 class="display-3 text-white mb-5">Espacios para eventos y oficinas</h1>
                </div>
            </div>
            <div class="carousel-item" data-bs-interval="7000">
                <img src="img/oficina2.jpg" class="d-block w-100 indexCarousel" alt="Espacio para eventos con pista de baile">
                <div class="carousel-caption">
                    <h1 class="display-3 text-white mb-5">Revisa nuestro catálogo virtual</h1>
                </div>
            </div>
        </div>
        <form action="catalogo" method="GET" class="buscador">
