...
--
-- Table structure for table `espacios_servicios`
--
...
--
-- Table structure for table `espacios_tipo_espacio`
--

CREATE TABLE `espacios_tipo_espacio` (
  `espacio_id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `usuarios` (
  ...
  `numero_celular` varchar(45) COLLATE utf8_spanish_ci NOT NULL,
  `correo_electronico` varchar(45) COLLATE utf8_spanish_ci NOT NULL,
  `contrasena` varchar(100) COLLATE utf8_spanish_ci NOT NULL,
  `perfil` enum('Administrador','Cliente') COLLATE utf8_spanish_ci NOT NULL,
  ...
  `comprobante_domicilio` varchar(100) COLLATE utf8_spanish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
ALTER TABLE `direcciones`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_direcciones_estados1_idx` (`estado_id`),
  ADD KEY `fk_direcciones_municipios1_idx` (`municipio_id`);
...
ALTER TABLE `espacios`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_espacios_direcciones1_idx` (`direccion_id`);

--
-- Indexes for table `espacios_servicios`
--
ALTER TABLE `espacios_servicios`
  ADD KEY `fk_espacios_servicios_espacios1_idx` (`espacio_id`),
  ADD KEY `fk_espacios_servicios_servicios1_idx` (`servicio_id`);

--
-- Indexes for table `espacios_tipo_espacio`
--
ALTER TABLE `espacios_tipo_espacio`
  ADD KEY `fk_espacios_tipo_espacio_espacios1_idx` (`espacio_id`),
  ADD KEY `fk_espacios_tipo_espacio_tipos_espacio1_idx` (`tipo_espacio_id`);
...
ALTER TABLE `fotografias`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_fotografias_espacios_idx` (`espacio_id`);
...
ALTER TABLE `rentas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_rentas_clientes1_idx` (`usuario_id`),
  ADD KEY `fk_rentas_espacios1_idx` (`espacio_id`);
...
--
-- Indexes for table `tipos_espacio`
--
...
--
ALTER TABLE `direcciones`
  ADD CONSTRAINT `fk_direcciones_estados1` FOREIGN KEY (`estado_id`) REFERENCES `estados` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_direcciones_municipios1` FOREIGN KEY (`municipio_id`) REFERENCES `municipios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `espacios`
--
ALTER TABLE `espacios`
  ADD CONSTRAINT `fk_espacios_direcciones1` FOREIGN KEY (`direccion_id`) REFERENCES `direcciones` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `espacios_servicios`
--
ALTER TABLE `espacios_servicios`
  ADD CONSTRAINT `fk_espacios_servicios_espacios1` FOREIGN KEY (`espacio_id`) REFERENCES `espacios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_espacios_servicios_servicios1` FOREIGN KEY (`servicio_id`) REFERENCES `servicios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `espacios_tipo_espacio`
--
ALTER TABLE `espacios_tipo_espacio`
  ADD CONSTRAINT `fk_espacios_tipo_espacio_espacios1` FOREIGN KEY (`espacio_id`) REFERENCES `espacios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_espacios_tipo_espacio_tipos_espacio1` FOREIGN KEY (`tipo_espacio_id`) REFERENCES `tipos_espacio` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Constraints for table `fotografias`
--
ALTER TABLE `fotografias`
  ADD CONSTRAINT `fk_fotografias_espacios` FOREIGN KEY (`espacio_id`) REFERENCES `espacios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `rentas`
  ADD CONSTRAINT `fk_rentas_clientes1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_rentas_espacios1` FOREIGN KEY (`espacio_id`) REFERENCES `espacios` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
